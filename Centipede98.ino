...
#define device_version 98 // Change to the ChromeOS version you expect to use with Centipede; Changes have been reported in the following ranges 58-68, 69, 70
...
#define password "DeviceEnrollmentUserSuperSecretPassword" // The password for the enrollment GAFE account.
...
#define password1 "GenericUserSuperSecretPassword" // The password for the generic student account.
